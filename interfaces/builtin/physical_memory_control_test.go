...
`)
	...
	c.Assert(aasnippets["snap.client-snap.app-accessing-physical-memory"], HasLen, 1)
	aasnippet := string(aasnippets["snap.client-snap.app-accessing-physical-memory"][0])
