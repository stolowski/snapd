...
func (s *BluezInterfaceSuite) TestConnectedPlugSnippetUsesSlotLabelAll(c *C) {
	...
	c.Assert(string(snippets["snap.other.app2"][0]), testutil.Contains, `peer=(label="snap.bluez.*"),`)
}
...
func (s *BluezInterfaceSuite) TestConnectedPlugSnippetUsesSlotLabelSome(c *C) {
	...
	c.Assert(len(snippets), Equals, 1)
	c.Assert(len(snippets["snap.other.app2"]), Equals, 1)
	c.Assert(string(snippets["snap.other.app2"][0]), testutil.Contains, `peer=(label="snap.bluez.{app1,app2}"),`)
}
...
func (s *BluezInterfaceSuite) TestConnectedPlugSnippetUsesSlotLabelOne(c *C) {
	...
	c.Assert(len(snippets), Equals, 1)
	c.Assert(len(snippets["snap.other.app2"]), Equals, 1)
	c.Assert(string(snippets["snap.other.app2"][0]), testutil.Contains, `peer=(label="snap.bluez.app"),`)
}
...
func (s *BluezInterfaceSuite) TestUsedSecuritySystems(c *C) {
	...
	c.Assert(len(apparmorSpec.Snippets()), Equals, 2)
