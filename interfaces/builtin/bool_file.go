...
func (iface *BoolFileInterface) AppArmorConnectedSlot(spec *apparmor.Specification, plug *interfaces.Plug, slot *interfaces.Slot) error {
	...
	return spec.AddSnippet([]byte(fmt.Sprintf("%s rwk,\n", path)))
}
