...
func (s *UDisks2InterfaceSuite) TestConnectedPlugSnippetUsesSlotLabelAll(c *C) {
	...
	c.Assert(len(snippets["snap.udisks2.app"]), Equals, 1)
	c.Assert(string(snippets["snap.udisks2.app"][0]), testutil.Contains, `peer=(label="snap.udisks2prod.*"),`)
}
...
func (s *UDisks2InterfaceSuite) TestConnectedPlugSnippetUsesSlotLabelSome(c *C) {
	...
	c.Assert(len(snippets), Equals, 1)
	c.Assert(len(snippets["snap.udisks2.app"]), Equals, 1)
	c.Assert(string(snippets["snap.udisks2.app"][0]), testutil.Contains, `peer=(label="snap.udisks2prod.{app1,app2}"),`)
}
...
func (s *UDisks2InterfaceSuite) TestConnectedPlugSnippetUsesSlotLabelOne(c *C) {
	...
	c.Assert(len(snippets), Equals, 1)
	c.Assert(len(snippets["snap.udisks2.app"]), Equals, 1)
	c.Assert(string(snippets["snap.udisks2.app"][0]), testutil.Contains, `peer=(label="snap.udisks2.app"),`)
}
...
func (s *UDisks2InterfaceSuite) TestConnectedSlotSnippetUsesPlugLabelAll(c *C) {
	...
	c.Assert(string(snippets["snap.udisks2.app1"][0]), testutil.Contains, `peer=(label="snap.udisks2client.*"),`)
}
...
func (s *UDisks2InterfaceSuite) TestConnectedSlotSnippetUsesPlugLabelSome(c *C) {
	...
	c.Assert(len(snippets), Equals, 1)
	c.Assert(len(snippets["snap.udisks2.app1"]), Equals, 1)
	c.Assert(string(snippets["snap.udisks2.app1"][0]), testutil.Contains, `peer=(label="snap.udisks2.{app1,app2}"),`)
}
...
func (s *UDisks2InterfaceSuite) TestConnectedSlotSnippetUsesPlugLabelOne(c *C) {
	...
	c.Assert(len(snippets), Equals, 1)
	c.Assert(len(snippets["snap.udisks2.app1"]), Equals, 1)
	c.Check(string(snippets["snap.udisks2.app1"][0]), testutil.Contains, `peer=(label="snap.udisks2.app"),`)
}
