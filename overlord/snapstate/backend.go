...
type managerBackend interface {
	...
	LinkSnap(info *snap.Info, dev boot.Device, tm timings.Measurer) (rebootRequired bool, err error)
	StartServices(svcs []*snap.AppInfo, disabledSvcs []string, enableBeforeStart bool, meter progress.Meter, tm timings.Measurer) error
