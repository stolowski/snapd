...
// missingDisabledServices returns a list of services that are present in this
// snap info and should be disabled, as well as services that were disabled
// and are currently missing (i.e. they were renamed in this snap info).
